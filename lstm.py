...
Leoben = pd.read_excel(r"C:\Users\AFayyaz Bakhsh\Downloads\PV.xlsx")
...
dataset = np.hstack((in_seq1,in_seq2,in_seq3,in_seq4, in_seq5,in_seq6, in_seq7,  in_seq8, in_seq9,in_seq10,in_seq12,out_seq))
